...
##    frame = image.array
    ...
    try:
        ret,imBin= cv2.threshold(fgmask,211,355,cv2.THRESH_BINARY)
        ret,imBin2 = cv2.threshold(fgmask2,211,355,cv2.THRESH_BINARY)
...
##            print str(i.getX()), ',', str(i.getY())
    ...
    #   IMAGES      #
    #################
    str_up = 'Masuk Jakarta: '+ str(cnt_up)
